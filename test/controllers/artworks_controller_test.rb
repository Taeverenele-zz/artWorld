...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { author: @artwork.author, description: @artwork.description, name: @artwork.name, price: @artwork.price } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { author: @artwork.author, description: @artwork.description, name: @artwork.name, price: @artwork.price } }
